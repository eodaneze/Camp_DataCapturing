        ...
        <table class="table table-bordered">
            ...
            <tbody>
                 <?php
                    ...
                    $sqlTotalItems = "SELECT category, COUNT(*) as children FROM campers WHERE category = 'Children'";
                    $resultTotalItems = mysqli_query($conn, $sqlTotalItems);
                    $rowTotalItems = mysqli_fetch_assoc($resultTotalItems);
                    $totalItems = $rowTotalItems['children'];
                    ...
                    $sqlData = "SELECT * FROM campers WHERE category = 'Children' LIMIT $offset, $itemsPerPage";

        ...
        <table class="table table-bordered">
            ...
            <tbody>
                 <?php
                    ...
                    $sqlTotalItems = "SELECT category, COUNT(*) as students FROM campers WHERE category = 'Student'";
                    $resultTotalItems = mysqli_query($conn, $sqlTotalItems);
                    $rowTotalItems = mysqli_fetch_assoc($resultTotalItems);
                    $totalItems = $rowTotalItems['students'];
                    ...
                    $sqlData = "SELECT * FROM campers WHERE category = 'student' LIMIT $offset, $itemsPerPage";

...
<div class="pagetitle">
                    <h1>SU Afikpo Zone || All Registered SUCF</h1>
                    <nav>
                        <ol class="breadcrumb">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                 <?php
                    ...
                    $sqlTotalItems = "SELECT category, COUNT(*) as sucf FROM campers WHERE category = 'SUCF'";
                    $resultTotalItems = mysqli_query($conn, $sqlTotalItems);
                    $rowTotalItems = mysqli_fetch_assoc($resultTotalItems);
                    $totalItems = $rowTotalItems['sucf'];
                    ...
                    $sqlData = "SELECT * FROM campers WHERE category = 'SUCF' LIMIT $offset, $itemsPerPage";

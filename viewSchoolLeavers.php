        ...
        <table class="table table-bordered">
            ...
            <tbody>
                 <?php
                    ...
                    $sqlTotalItems = "SELECT category, COUNT(*) as sleavers FROM campers WHERE category = 'School Leaver'";
                    $resultTotalItems = mysqli_query($conn, $sqlTotalItems);
                    $rowTotalItems = mysqli_fetch_assoc($resultTotalItems);
                    $totalItems = $rowTotalItems['sleavers'];
                    ...
                    $sqlData = "SELECT * FROM campers WHERE category = 'School Leaver' LIMIT $offset, $itemsPerPage";
